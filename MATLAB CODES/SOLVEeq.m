...
% this function containes all the 5 equations to find the fixed points
...
%% CONSTRAINED zita1=zita2=zita 3 variables
zita1=y(1); 
zita2=y(1); % for tandem
%zita2=-y(1); %for staggered 
thetaf1=y(2);
thetaf2=y(3);
psi=ps;
delta=l;
